...
class WENDy:
    ...
    Inputs:
       ...
       mt_params: tf radii 
       toggle_VVp_svd # 0: no SVD reduction 
       toggle_VVp_svd in (0,1): truncates Frobenious norm
       toggle_VVp_svd:  NaN, truncates SVD according to cornerpoint of cumulative sum of singular values
       w0 : first guess
